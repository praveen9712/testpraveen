...
public class JodaLocalDateTimeDeserializerTest {
  ...
  public void setup() {
    ...
    module.addDeserializer(LocalDateTime.class, new JodaLocalDateTimeDeserializer());
  ...
  public void testDeserializeNull() throws IOException {
    LocalDateTime result = mapper.readValue("null", LocalDateTime.class);
    Assert.assertNull(result);
  }

  @Test
  public void testDeserializeFull() throws IOException {
    LocalDateTime result = mapper.readValue("\"2015-12-25T09:38:10.060\"", LocalDateTime.class);
    Assert.assertNotNull(result);
  }

  @Test(expected = WebApplicationException.class)
  public void testDeserializeWholeNumber() throws IOException {
    mapper.readValue("2015", LocalDateTime.class);
  }
