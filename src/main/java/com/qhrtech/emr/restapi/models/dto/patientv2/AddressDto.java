...
@Schema(description = "Address data transfer object model. In any of these fields "
    ...
    implementation = AddressDto.class, name = "AddressV2Dto")
public class AddressDto {

  @JsonProperty("street")
  @Schema(
      description = "Street of the address",
      example = "102 Maple Street", type = "string", maxLength = 200)
  @Size(max = 200, message = "The street size should not be greater than 200 characters")
  private String street;

  @JsonProperty("city")
  @Schema(
      description = "City name of the address",
      example = "Vancouver", type = "string", maxLength = 100)
  @Size(max = 100, message = "The city size should not be greater than 100 characters")
  private String city;
  ...
  @Schema(
      ...
      example = "A quick note", type = "string", maxLength = 200)
  @Size(max = 200, message = "The note size should not be greater than 200 characters")
  private String note;
  ...
  @Schema(
      ...
      example = "Civil", type = "string", maxLength = 10)
  @Size(max = 10, message = "The address type size should not be greater than 10 characters")
  private String type;
  ...
  public String getPostalZip() {
    ...
    return postalZip == null ? null : postalZip.trim();
  }
