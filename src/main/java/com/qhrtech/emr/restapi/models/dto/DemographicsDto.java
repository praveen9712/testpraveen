...
@Schema(description = "Demographics of a person associated with Accuro, e.g. patient.",
    implementation = DemographicsDto.class, name = "DemographicsDto")
public class DemographicsDto {

  @JsonProperty("firstName")
  @Schema(description = "The person's first name", type = "string", example = "John",
      nullable = true, maxLength = 100)
  private String firstName;

  @JsonProperty("lastName")
  @Schema(description = "The person's last name", type = "string", example = "Doe", nullable = true,
      maxLength = 100)
  private String lastName;

  @JsonProperty("middleName")
  @Schema(description = "The person's middle name", type = "string", example = "Smith",
      nullable = true, maxLength = 100)
  private String middleName;

  @JsonProperty("title")
  @Schema(description = "The person's honorific (Mrs., Dr., etc.)", type = "string",
      example = "Mr.", nullable = true, maxLength = 50)
  private String title;

  @JsonProperty("suffix")
  @Schema(description = "The person's name suffix (Jr., Sr., etc.)", type = "string",
      example = "Sr.", nullable = true, maxLength = 10)
  ...
  @Schema(description = "The person's gender", type = "integer", example = "1", required = true)
  ...
  @Schema(description = "The persons's listed next of kin", type = "string", example = "Jane Doe",
   ...
   */
  @DocumentationExample("1959-02-16T00:00:00.000-0800")
