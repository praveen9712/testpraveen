...
+function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    this.backdrop(function () {
      ...
      .emulateTransitionEnd(Modal.TRANSITION_DURATION) : that.$element.trigger(
          'focus').trigger(e)
    })
  }
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        > containerDim.bottom ? 'top' : placement == 'top' && pos.top
        - actualHeight < containerDim.top ? 'bottom' : placement == 'right'
        && pos.right + actualWidth > containerDim.width ? 'left' : placement
        == 'left' && pos.left - actualWidth < containerDim.left ? 'right'
            : placement
